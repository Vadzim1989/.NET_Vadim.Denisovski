...
{
    public class SquareMadeByFilm : Square, IFilm
    {
        /// <summary>
        /// Default Constructor
        /// </summary>
        /// <param name="d">Input height</param>
        public SquareMadeByFilm(float d) : base(d)
        {
        ...
        /// <param name="d">Input height</param>
        public SquareMadeByFilm(IFigure figure, float d) : base(figure, d)
        {
            if (!(figure is IFilm))
            {
        ...
        {
            if (obj is SquareMadeByFilm)
            {
                if (this.A == ((SquareMadeByFilm)obj).A)
                {
                    return true;
                }
                else return false;
